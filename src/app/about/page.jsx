  ...
  return (
    <div className='max-w-6xl mx-auto space-y-4'>
      ...
      <p>
        ...
        and trailers. Our movie database is constantly updated with the latest
        movies and TV shows, and we also provide you with the option to create
        your own watchlist. You can search for movies by title, genre, or
        release date, making it easy to find the perfect movie for any occasion.
      </p>
      <p>
